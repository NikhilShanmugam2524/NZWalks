	...
	public class WalkRepository : IWalkRepository
	{
		...
		public async Task<IEnumerable<Walk>> GetAllAsync()
		{
			return await
				...
				.Include(x => x.Region)  //Navigation Property, so that other table values are also seen ; 
										 //Since walk and region map are linked, include() will show the region details using the regionid in walk table
