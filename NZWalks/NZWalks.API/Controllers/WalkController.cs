...
namespace NZWalks.API.Controllers
{
	...
	public class WalkController : Controller
	{
		...
		private readonly IRegionRepository regionRepository;  //Because values from Region table is used
		private readonly IWalkDifficultyRepository walkDifficultyRepository;  //Because values from WalkDifficulty table is used
